...
class SimulationManager:
    ...
    def step(self, stash='active', n=None, selector_func=None, step_func=None,
        ...
        for state in self._fetch_states(stash=stash):
            ...
            constraint_number = constraint_number + len(state.solver.constraints)
            global constraints


            for con in state.solver.constraints:

                global constraint_depth
                constraint_depth = constraint_depth + con.depth
                #constraints.append(str(con))

                global variable_number
                variable_number = variable_number + len(con.variables)
